...
public class Principal {
	...
	public static void introducirTecnico(Empleado[] vector) {
		...
		vector[Empleado.getSiguiente()] = new Tecnico(nombre, fecha_nacimiento, fechaIngreso, especialidad, plusEspecialidad, (Responsable) vector[i]);
	}
	public static void introducirAdministrativo(Empleado[] vector) {
		...
		int i=Leer.pedirEntero("introduzca el responsable");
		vector[Empleado.getSiguiente()] = new Administrativo(nombre, fecha_nacimiento, fechaIngreso, departamento, (Responsable) vector[i]);
	}
