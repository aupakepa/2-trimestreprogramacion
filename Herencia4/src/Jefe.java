...
public String toString() {
	return "Jefe[NomEmp=" + getNomEmp() + ", nombre=" + getNombre() + ", edad=" + getEdad() + ", porIncremento=" + getPorIncremento() + ", sueldo=" + (getSueldoBase()*getPorIncremento())+plus + "nomDepart=" + nomDepart + "]";
}
